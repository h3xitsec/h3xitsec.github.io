...
We have n,c (public modulus, ciphertext) from output.exe and e (public exponent) from gen.py. It's pretty clear that we have to recover plaintext from ciphertext.
Steps for solving:
- Generate public key with n,e
- Factor n to get p,q,d
